...
Across 46 random runs, the following confusion matrix was produced.
\begin{figure}[hbt!]
    \centering
...
At the end, taking into consideration how our model performs across many seeds, we can confidently say that the \textbf{Naive Bayes Projected Accuracy is more than 70\%}

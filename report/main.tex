...
\section{Results}
\qquad We evaluated our Naive Bayes model (with optimal n\_estimators=100, alpha=0.5) across 200 different random seeds to systematically verify that our performance is not an artifact of a particular data split. Each seed produces an independent 84-16 train-test partition at the student level, ensuring no overlap in the students between splits.
